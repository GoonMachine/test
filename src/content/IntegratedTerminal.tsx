...
const IntegratedTerminal = (props: {
  ...
  return (
    <div className="min-h-[600px] h-[600px] w-full rounded-2xl text-white flex flex-col items-center p-2 lg:p-4 mb-4 overflow-hidden">
      <div className="flex flex-col lg:flex-row h-full w-full overflow-auto">
        <div className="w-full h-full rounded-xl overflow-hidden flex justify-center">
          {/* Loading state */}
          {!isLoaded ? (
            <div className="h-full w-full animate-pulse mt-4 lg:mt-0 lg:ml-4 flex items-center justify-center rounded-xl">
          ...
          <div
            ...
            className={`flex h-full w-full max-w-[384px] overflow-auto justify-center bg-[#1B2453] rounded-xl ${
              !isLoaded ? 'hidden' : ''
            }`}
          />
        </div>
